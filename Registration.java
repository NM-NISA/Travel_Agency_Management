...
public class Registration extends JFrame {
    ...
    Registration() {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/images/Logoc.png"));
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textField5.isEmpty()) {
                    ...
                    if (userName == "" || password == "") {
                        ...
                        FileIO.registerUser(userName, password, "./Data/user.txt");

                        JOptionPane.showMessageDialog(null, "user registered", "", JOptionPane.WARNING_MESSAGE);
