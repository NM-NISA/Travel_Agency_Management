...
public class Packs extends JFrame {
    ...
    Packs() {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/images/Logob.png"));
        ...
        // Label
        label1 = new JLabel();
        label1.setText("Select Your Packages");
        ...
        defPacks = new JRadioButton("Default Packages");
        ...
        selfChosenPacks = new JRadioButton("Custom Packages");
