...
public class DomesticSajekValley extends JFrame {
    ...
    DomesticSajekValley() {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/images/bd.png"));
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Packs Available for Sajek Valley");
