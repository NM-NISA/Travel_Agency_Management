...
public class InternationalItaly extends JFrame {
    ...
    InternationalItaly() {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/images/b1.png"));
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Packs Available for Italy Tour!");
